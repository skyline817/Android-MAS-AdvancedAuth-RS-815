...
public class AppUtil {
    ...
    public static void initAppConstants (Activity activity) {
        ...
        ApplicationConstants.ENABLE_BIOMETRIC_LOGIN = sharedPref.getBoolean(ENABLE_BIOMETRIC_LOGIN, false);
        ApplicationConstants.LOCATION = sharedPref.getString(LOCATION, "DISABLED");
